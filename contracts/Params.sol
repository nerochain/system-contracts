...
contract Params {
    ...
    uint8 public constant MaxValidators = 5;
    ...
    uint public constant JailPeriod = 1200; // amount of blocks, about 1 hours at 3 sec/block.
    uint public constant UnboundLockPeriod = 1 hours; // Seconds delay when a validator unbound staking.
    ...
    uint256 public constant LazyPunishThreshold = 400; // accumulate amount of missing blocks for a validator to be punished
